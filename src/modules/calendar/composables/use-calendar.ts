...
import { calendarStorageSchema, type CalendarStorageSchemaType, type ICalendarStorage } from '../model/storage';
...
export function useCalendar(options: IUseCalendarStateOptions) {
	const {
		widget,
		defaults = {},
	} = options;
