...
const experimentalSections = {
	...
	[TICKER_SECTION_COMPONENT.STOCK_INSIGHTS_AND_ACTIVITY]:
		isFeatureEnabled('TICKER_WIDGET_INDICATORS_ENABLED')
		|| isFeatureEnabled('TICKER_WIDGET_ACTIVITY_METRICS_ENABLED'),
	[TICKER_SECTION_COMPONENT.STOCK_OVERVIEW]: isFeatureEnabled('TICKER_WIDGET_PRICE_PERFORMANCE_ENABLED'),
	[TICKER_SECTION_COMPONENT.FOREX_OVERVIEW]: isFeatureEnabled('TICKER_WIDGET_PRICE_PERFORMANCE_ENABLED'),
	[TICKER_SECTION_COMPONENT.CRYPTO_OVERVIEW]: isFeatureEnabled('TICKER_WIDGET_PRICE_PERFORMANCE_ENABLED'),
	[TICKER_SECTION_COMPONENT.ETF_OVERVIEW]: isFeatureEnabled('TICKER_WIDGET_PRICE_PERFORMANCE_ENABLED'),
	[TICKER_SECTION_COMPONENT.INDEX_OVERVIEW]: isFeatureEnabled('TICKER_WIDGET_PRICE_PERFORMANCE_ENABLED'),
	[TICKER_SECTION_COMPONENT.COMMODITY_OVERVIEW]: isFeatureEnabled('TICKER_WIDGET_PRICE_PERFORMANCE_ENABLED'),
	[TICKER_SECTION_COMPONENT.STOCK_VALUATION_AND_ESTIMATES]: isFeatureEnabled('TICKER_WIDGET_ANALYST_RATINGS_ENABLED'),
