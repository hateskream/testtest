		...
		<modal-badge-dropdown :display-variant="props.displayVariant">
			...
			<template #content>
				<modal-badge-list>
					...
					<template
						v-for="filterKey in props.cpis"
						:key="filterKey"
					>
						<modal-item-selector
							:model-value="filterKey === activeDateRange"
							@update:model-value="activeCPI = filterKey"
						>
							{{ displayValueCpi[filterKey] }}
						</modal-item-selector>
					</template>
				</modal-badge-list>
			</template>
