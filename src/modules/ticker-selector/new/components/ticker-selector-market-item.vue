...
const active = computed(() =>
	isMarketTickerSelected(props.market.market_type, props.market.id),
);

function onClick() {
	toggleMarketTicker(props.market.market_type, props.market);
}
</script>
...
<template>
	<button
		...
		@click="onClick"
	>
		<market-ticker-icon :class="classes.leftIcon" :icon="props.market.icon" />
		...
		<span :class="[classes.rightIcon, { [classes.active]: active }]">
			<ui-icon
