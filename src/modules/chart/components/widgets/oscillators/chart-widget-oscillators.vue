...
import type { IMovingAveragesSignal } from '../moving-averages/models/moving-averages';
import { getDefaultMovingAveragesViewState } from '../moving-averages/models/moving-averages';

import OscillatorsChart from './oscillators-chart.vue';
