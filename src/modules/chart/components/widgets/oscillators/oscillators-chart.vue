...
import type { IMovingAveragesSignal, IMovingAveragesSize, IMovingAveragesSettings, IMovingAveragesTextData } from '../moving-averages/models/moving-averages';
import { MovingAveragesSignal } from '../moving-averages/models/moving-averages';
import { useMapMovingAverages } from '../moving-averages/composables/use-map-moving-averages';
