	...
	if (context.tooltip.body) {
		...
		bodyLines.forEach((body, i) => {
			...
			if (i === 0) {
				...
				spanCircleText.textContent = 'Total Assets';

			} else if (i === 1) {
				spanCircle.style.background = 'rgba(231, 181, 37, 1)';
				spanCircleText.textContent = 'Total Liabilities';
			} else if (i === 2) {
				spanCircle.style.background = 'rgba(255, 255, 255, 1)';
				spanCircleText.textContent = 'Debt to Assets';
			}
