...
export const notes: IWeekGroup[] = [
	...
	},
	{
		...
		items: [
			{
				id: '70',
				title: 'Исправлен баг с поведение модальных окон при прокрутке экрана',
				description: 'Теперь модальные окна не вылезают за пределы экрана при прокрутке',
				productLink: '/',
			},
			{
				id: '71',
				title: 'Унифицирован и приведен к единому дизайну компонент выпадающих модальных окон',
				description: 'Теперь все модальные окна имеют одинаковый визуал и поведение',
				productLink: '/',
			},
			{
				id: '72',
				title: 'График из виджета Nominal gross domestic product приведен к макету',
				description: 'Теперь график имеет одинаковый визуал с макетом',
				productLink: '/',
			},
			{
				id: '73',
				title: 'Приведение виджета Top Indices к макету',
				description:
      'Виджет Top Indices полностью приведён к актуальному макету: обновлена верстка, ' +
      'переработаны отступы, типографика и поведение элементов. ' +
      'Все несоответствия между прототипом и финальным дизайном устранены.',
				figmaLink:
      'https://www.figma.com/design/5aCKSgIfAiKBurXVLM6P51/P9.-i88---v2.3.1--%E2%8F%B0-NEW-?node-id=39017-171468&t=Y8CjCwsNRS4yBAtB-1',
			},
			{
				id: '74',
				title: 'Обновление виджета Performance',
				description:
      'Виджет Performance синхронизирован с макетом: переработана структура, ' +
      'обновлены UI-элементы, исправлены расхождения между прототипом и дизайном. ' +
      'Теперь отображение данных полностью соответствует требованиям макета.',
				figmaLink:
      'https://www.figma.com/design/5aCKSgIfAiKBurXVLM6P51/P9.-i88---v2.3.1--%E2%8F%B0-NEW-?node-id=39017-171468&t=Y8CjCwsNRS4yBAtB-1',
			},
			{
				id: '75',
				title: 'Обновлённая логика адаптивных таблиц',
				description:
      'По всему проекту обновлена логика работы таблиц. Теперь таблицы автоматически ' +
      'адаптируются под переданные параметры и выбирают оптимальную стратегию ' +
      'выравнивания и скрытия колонок. Повышена стабильность и предсказуемость поведения.',
			},
			{
				id: '76',
				title: 'Исправление визуальных багов в хедере Dashboard',
				description:
      'Исправлены визуальные артефакты в хедере Dashboard, оставшиеся с TV-страницы. ' +
      'Улучшена визуальная целостность и корректность отображения элементов.',
			},
			{
				id: '77',
				title: 'События и таймлайн работы рынка на Price Chart',
				description: 'Добавлен вывод маркеров событий, потенциально влияющих на цену, под графиком цены. Добален таймлайн работы рынка.',
				productLink: '/',
			},
			{
				id: '78',
				title: 'Правки по виджету Price List',
				description: 'Исправлен неправильный эффект градиента в hover состоянии, внедрены реальные данные графиков с API',
				productLink: '/',
			},
			{
				id: '79',
				title: 'Внедрение meta-информации о продукте',
				description: 'Заданы заголовок и описание для каждой страницы продукта, превью и логотип для закладок. Это важно для индексации, узнаваемости в сети и превью в поисковой выдаче.',
				productLink: '/',
			},
			{
				id: '80',
				title: 'Перенос основных страниц на новый Layout',
				description: '',
				productLink: '/',
			},
		],
